...
public class DateTimePicker {
    ...
    public void testDAtePicker() throws Exception{
       ...
       // driver.get("http://vmcrmuat:9010/#/cfsg/courseadmin/courses/3");
        // System.out.println("this fir testing purpose onlyKING GEORGE GREatness111")
        ...
        WebElement selectDate = driver.findElement(By.xpath(".//*[@id='mainSection']/div/div[4]/div[1]/div[3]/div/rhs-form[1]/ng-form/div[1]/div/span/button"));
    ...
    WebElement nextLink = driver.findElement(By.xpath(".//*[@id='datepicker-53-8791-title']"));
